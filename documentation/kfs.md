...
A section identifier is a two-byte identifer that refers to a location within the DAT. The first byte is the Flash
page, and the second byte is the index in the DAT.
